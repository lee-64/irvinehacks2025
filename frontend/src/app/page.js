  ...
  return (
      <div className="sm:p-10">
        ...
        <div className="h-screen flex items-center flex-row">
          <div className="basis-1/2 text-left sm:p-10">
            <div className="lg:w-4/5 mx-auto space-y-10">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight">
                <span className="bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Looking for your</span>{" "}
                <span className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">
              next adventure
            </span>{" "}
                or{" "}
                <span
                    className="bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">place to call</span>{" "}
              ...
              <div className="space-y-6">
                <p className="text-blue-600 text-xl font-semibold inline-block hover:text-blue-700 transition-colors cursor-pointer">
                  Explore ZipScope →
                </p>

                <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                  Your SoCal neighborhood guide – for travelers, new home seekers, and more. Get comprehensive data
                  insights into the best areas in the LA/OC area.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="basis-1/2 text-center flex justify-center items-center w-full">
            <div className="h-96 w-96 rounded-lg shadow-2xl">
              <img
                  src="/skyline.png"
                  alt="City Skyline"
        ...
        <div
            className="py-16 bg-gradient-to-r from-gray-100 via-white to-gray-100 mb-10"
            style={{
